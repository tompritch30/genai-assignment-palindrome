...
from src.utils.search_tools import SearchTools, SearchMatch
...
class TestSearchExact:
    ...
    def test_context_included(self, employment_narrative):
        ...
        assert "Pinnacle Investment Bank" in results[0].context or "as a" in results[0].context
...
class TestEdgeCases:
    ...
    def test_very_long_narrative(self):
        ...
        long_narrative = "The company " + ("generated revenue. " * 1000) + "Acorn Financial Group was mentioned."
    ...
    def test_multiline_narrative(self):
        ...
        assert any("Oakwood" in org for org in orgs) or any("Capital" in org for org in orgs)
